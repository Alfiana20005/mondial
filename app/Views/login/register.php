    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          ...
          <img src="<?= base_url('image/login/register.png') ?>" width="115%">
          </div>
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" action="/save_register" method="post" id="formDaftar">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                  <h1 class="h6 text-gray-900 mb-10">Ulangi Kata Sandi</h1>
                    <input type="password" class="form-control form-control-user" id="repeat_password" name="repeat_password" onkeyup="repeat(this.value)" placeholder="Ulangi Kata Sandi" required="">
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="<?= base_url('login/forgot') ?>">Lupa Kata Sandi?</a>
              </div>
              <div class="text-center">
