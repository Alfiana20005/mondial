              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">Kami akan mengirimkan pasword baru untukmu lewat email!</p>
                  </div>
                  <form class="user">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="email" placeholder="Masukkan Email">
                    </div>
      ...
      $.ajax({
        ...
        success: function(data) {
          if(data.status == 200) {
            swal({
              title: "Berhasil!",
              text: "Password baru akan dikirim ke email anda,segera ganti password anda!!",
              icon: "success",
              button: "oke",
            }).then((status)=>{
