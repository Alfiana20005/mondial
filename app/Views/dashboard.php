            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Kegiatan(1 tahun)</div>
          ...
          <div class="row">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Grafik Pemasukan dan Pengeluaran 5 Tahun Terakhir Uang Karang Taruna MONDIAL</h6>
                </div>
                <div class="card-body">
                    <div class="chart-bar">
            ...
            <script>
        // Data pemasukan dan pengeluaran untuk 3 bulan terakhir
...
<div class="modal fade" id="modalPengaduan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <script type="text/javascript">
    ...
    function show_modal(id_kegiatan) {
        $.ajax({
            url: "<?= base_url() ?>Welcome/load_data/"+id_kegiatan,
            dataType: "json",
            success: function(data) {
